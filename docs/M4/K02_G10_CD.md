...
| *C02* | *AntarmukaPolisi* | ** | *kirimReply()* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *OneClickSOS* | ** | *dapatLokasi(), kirimSinyal(lokasi), signalMikrofon(), menerimaReply(reply)* |
...
| *C03* | *UC01, UC04, UC07* | *KF01,KF02,KF03,KF04,KF07,KF08* |
| *C04* | *UC04* |
| *C05* | *UC04* |
| *C06* | *UC04* |
| *C07* | *UC04* |
| *C08* | *UC01, UC07* | *KF01,KF02,KF03,KF04,KF07,KF08* |
| *C09* | *UC06* |
