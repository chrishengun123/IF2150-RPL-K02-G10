...
| :--- | :--- | :--- | :--- | :--- |
| *R01* | *A01* | *User* | *User dapat menggunakan fitur one click SOS melalui aplikasi atau widget untuk mengirimkan lokasi kepada polisi saat keadaan darurat.* | *Ya* |
...
| *R04* | *A01* | *System* | *Sistem harus mengamankan laporan awal untuk memastikan keabsahan bukti dalam ranah hukum.* | *Ya* |
...
| *R10* | *A04* | *Business* | *Proses penanganan, pengambilan, serta penyimpanan bukti digital kekerasan harus tetap dalam batas regulasi hukum yang berlaku.* | *Tidak* |
| *R11* | *A05* | *User* | *Polisi yang memantau notifikasi dapat melihat lokasi korban dan mengirimkan notifikasi kembali kepada korban sebagai konfirmasi bantuan dalam perjalanan.* | *Ya* |
| *R12* | *A06* | *System* | *Sistem dapat mengirimkan pembaruan data lokasi secara terus-menerus ke pihak kepolisian.* | *Ya* |
| *R13* | *A07* | *System* | *Sistem menyediakan mekanisme untuk menonaktifkan status darurat SOS berdasarkan input dari pihak kepolisian.* | *Ya* |
| *R14* | *A07* | *System* | *Sistem harus dapat mengirimkan file rekaman suara ke pihak kepolisian setelah status darurat selesai.* | *Ya* |
