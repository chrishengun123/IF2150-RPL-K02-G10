...
| :--- | :--- | :--- | :--- |
| US-01 | *Korban* | *Melaporkan kekerasan secara cepat, anonim, dan diam diam* | *Elaborasikan* |
| US-02 | *Korban* | *Mengakses peta real time untuk layanan terdekat seperti rumah sakit dan konseling* | *Elaborasikan juga* |
| US-03 | *Korban* | *Melihat kontak telepon layanan terdekat dan menelepon langsung dari aplikasi* | *Elaborasikan juga* |
| US-04 | *Korban* | *Menerima notifikasi konfirmasi dari polisi bahwa SOS diterima* | *Elaborasikan juga* |
| US-05 | *Polisi* | *Menerima laporan dengan data lokasi, dan waktu kejadian yang akurat* | *Elaborasikan juga* |
| US-06 | *Polisi* | *Mengakses rekaman suara yang terekam otomatis saat SOS diaktifkan* | *Elaborasikan juga* |
| US-06 | *Polisi* | *Mengirimkan notifikasi status penanganan ke korban* | *Elaborasikan juga* |
| ... | ... | ... | ... |
